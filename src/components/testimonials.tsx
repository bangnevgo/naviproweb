      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 text-sm mb-4">
            <span className="text-primary">Kata Mereka</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className={`glass-card rounded-xl border bg-slate-900/50 p-6 hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 relative neon-border-glow ${
                testimonial.featured
                  ? 'border-primary/40 shadow-lg shadow-primary/10 md:-translate-y-2'
                  : 'border-primary/15'
              }`}
            >
              {testimonial.featured && (
              ...
              <p className="text-sm text-slate-400 mb-4 leading-relaxed">{testimonial.text}</p>
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-chart-2 flex items-center justify-center text-primary-foreground font-bold text-sm shadow-lg shadow-primary/20">
